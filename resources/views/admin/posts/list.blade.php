                            ...
                            <div class="card-box">
                                <div class="dropdown float-right">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        ...
                                        <a  style="color: #ff3535" href="{{ route('post.destroy', [app()->getLocale(), $post->id]) }}" data-confirm="დარწმუნებული ხართ რომ გსურთ პოსტის წაშლა?" class="dropdown-item delete">{{ trans('admin.delete') }}</a>
